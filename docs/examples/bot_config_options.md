...
Have a look at the [SQLiteStorage](../reference/storage.md) class for how to store and retrieve the data.
...
Have a look at the [RedisStorage](../reference/storage.md) class for how to store and retrieve the data.
